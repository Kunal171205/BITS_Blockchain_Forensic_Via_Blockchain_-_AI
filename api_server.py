...
from business_logic.services.ml_inference import run_inference, get_model_status
...
def health():
    # 1. Pipeline/Model Status
    status_info = get_model_status()
    
    # 2. Blockchain Connection Status
    ...
    try:
        ...
        print(f"⚠️ Health check failed to connect to Web3: {e}")
